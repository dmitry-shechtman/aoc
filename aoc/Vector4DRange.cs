...
namespace aoc
{
    ...
    public readonly struct Vector4DRange : IIntegerRange<Vector4DRange, Vector4D, int>, IRange4D<Vector4DRange, Vector4D, int>
    {
        ...
        public static Vector4DRange Parse(string s, char separator, IFormatProvider provider = null) =>
        ...
        public static bool TryParse(string s, char separator, IFormatProvider provider, out Vector4DRange range) =>
            Helper.TryParse(s, separator, provider, out range);

        public static Vector4DRange Parse(string s, string separator, IFormatProvider provider = null) =>
            Helper.Parse(s, separator, provider);

        public static bool TryParse(string s, string separator, out Vector4DRange range) =>
            Helper.TryParse(s, separator, out range);

        public static bool TryParse(string s, string separator, IFormatProvider provider, out Vector4DRange range) =>
            Helper.TryParse(s, separator, provider, out range);

        public static Vector4DRange Parse(string s, Regex separator, IFormatProvider provider = null) =>
            Helper.Parse(s, separator, provider);

        public static bool TryParse(string s, Regex separator, out Vector4DRange range) =>
            Helper.TryParse(s, separator, out range);

        public static bool TryParse(string s, Regex separator, IFormatProvider provider, out Vector4DRange range) =>
            Helper.TryParse(s, separator, provider, out range);

        public static Vector4DRange Parse(string s, char separator, char separator2, IFormatProvider provider = null) =>
        ...
        public static bool TryParse(string s, char separator, char separator2, IFormatProvider provider, out Vector4DRange range) =>
            Helper.TryParse(s, separator, separator2, provider, out range);

        public static Vector4DRange ParseAny(string input, IFormatProvider provider = null) =>
        ...
        public static bool TryParseAny(string input, IFormatProvider provider, out Vector4DRange range) =>
            Helper.TryParseAny(input, provider, out range);

        public static Vector4DRange[] ParseAll(string input, IFormatProvider provider = null) =>
        ...
        public static bool TryParseAll(string input, IFormatProvider provider, out Vector4DRange[] ranges) =>
