...
namespace aoc
{
    ...
    public struct Particle3D : IParticle<Particle3D, Vector3D, int>
    {
        ...
        public static bool TryParse(string s, out Particle3D particle) =>
            Helper.TryParse(s, out particle);

        public static Particle3D Parse(string s, char separator) =>
            Helper.Parse(s, separator);

        public static bool TryParse(string s, char separator, out Particle3D particle) =>
        ...
        public static bool TryParse(string s, char separator, char separator2, out Particle3D particle) =>
            Helper.TryParse(s, separator, separator2, out particle);

        public static Particle3D Parse(string[] ss) =>
            Helper.Parse(ss);

        public static bool TryParse(string[] ss, out Particle3D particle) =>
            Helper.TryParse(ss, out particle);

        public static Particle3D Parse(string[] ss, char separator) =>
            Helper.Parse(ss, separator);

        public static bool TryParse(string[] ss, char separator, out Particle3D particle) =>
